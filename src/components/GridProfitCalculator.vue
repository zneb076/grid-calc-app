...
<template>
  <div class="grid-calc-container max-w-lg mx-auto p-4 bg-gray-50 min-h-screen">
    <h2 class="app-title text-center text-xl font-semibold text-gray-800 mb-4 pt-4">
      🤖 Grid Bot Profit Calc
    </h2>
    <p class="text-center text-xs text-gray-400 -mt-3 mb-4">v{{ APP_VERSION }} · {{ BUILD_DATE }}</p>
    ...
    <div class="bg-white p-3 rounded-xl shadow-lg border border-gray-200 mb-4">
      <div class="flex justify-between items-center mb-2">
        <p class="text-sm font-semibold text-gray-700">📡 ข้อมูลจาก Binance</p>
        <button
          @click="refreshMarket"
    ...
    <div class="input-section bg-white p-3 rounded-xl shadow-lg mb-4">
      <h3 class="text-lg font-medium text-center text-gray-700 mb-3">
        1. ตั้งค่ากริด ({{ symbol }}, {{ common.gridType }})
      </h3>
    ...
    <div class="bg-white p-4 rounded-xl shadow-lg mb-4">
      <h3 class="text-lg font-medium text-gray-700 pb-2 border-b border-gray-200">
        3. ATR Grid Recommendations ({{ fmt(s.priceUpper - s.priceLower, 0) }} USDT Range)
      </h3>
    ...
    <div class="bg-white p-4 rounded-xl shadow-lg mb-4 border-2 border-purple-300">
      <h3 class="text-lg font-medium text-gray-700 pb-2 border-b border-gray-200">
        4. อยากได้กำไรวันละกี่ $ → ต้องใช้ทุนเท่าไหร่
      </h3>
    ...
    <div class="bg-white p-4 rounded-xl shadow-lg mb-4">
      <h3 class="text-lg font-medium text-gray-700 pb-2 border-b border-gray-200">
        5. Goal Seeker (เป้า %/ปี หรือ %/วัน → หากรอบราคา)
      </h3>
      <div class="flex flex-col items-center pt-3">
        <div class="flex space-x-2 mb-2">
